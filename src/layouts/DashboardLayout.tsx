...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background dark:bg-navy-darkest"> {/* Ensure main background */} 
             ...
             <Tooltip>
               <TooltipTrigger asChild> 
                  <Button
                    ...
                    className="bg-card/50 dark:bg-navy-light/50 backdrop-blur-sm text-muted-foreground dark:text-white hover:bg-accent dark:hover:bg-navy-light dark:hover:text-white rounded-full h-8 w-8 border border-border dark:border-navy-medium"
                  >
                    {isSidebarOpen ? <PanelLeft size={16} /> : <PanelRight size={16} />}
                  </Button>
               </TooltipTrigger>
               {/* Use theme colors if available */} 
               <TooltipContent side="right" className="bg-popover dark:bg-navy-darkest text-popover-foreground dark:text-white border-border dark:border-navy-medium">
